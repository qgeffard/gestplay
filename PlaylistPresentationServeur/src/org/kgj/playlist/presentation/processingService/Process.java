...
public class Process {
	...
	private void start() {		
		System.out.println("PRES : Requète reçu - Dispatching...");
	 ...
	 */
	private void login() {
		System.out.println("PRES : Requète reçu : Login");
	 ...
	 */
	private void update() {
		System.out.println("PRES : Requète reçu : Update.");
		if (this.query.getStatus().getSucced() != null) {
			MyServlet.setSes(1,"0");
			MyServlet.sesSes(10,this.query.getPlaylist().get(0).getIdentifier().toString());
		} else {
	...
	private void undoRedo() {
		System.out.println("PRES : Requète reçu : "+this.query.getAction().getNameAction()+".");
		if (this.query.getStatus().getSucced() != null) {
			MyServlet.setSes(1,"0");
			MyServlet.setSes(3,(List<PlaylistType>) this.query.getPlaylist());
		} else {
